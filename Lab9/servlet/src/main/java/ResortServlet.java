...
public class ResortServlet extends HttpServlet {
    private static ResortsSkierDAO dao;

    public void init() {
        ResortServlet.dao = new ResortsSkierDAO();
    }
...
//            System.out.println("not valid");
            ...
            int numSkiers = dao.getResortRides(resortID, seasonID, dayID);
            ResortSkierOutput resortSkierOutput = new ResortSkierOutput("" + resortID, numSkiers);
